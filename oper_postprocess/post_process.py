...
def silver_postprocess(destination_dir, scenario,
                       silver_output_dir=fixpath(r"C:\SILVER_BC_Cascade\SILVER_Data\Model Results")):
    
    scen = scenario
    silver_output_dir = os.path.join(silver_output_dir, r"BC_Cascade_{}".format(scen))
    scen_dir = os.path.join(destination_dir, scen)
